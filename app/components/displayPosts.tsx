              ...
              <>
                <SplideSlide key={post.slug}>
                  <Link
                    ...
                    href={`/blog/${post.slug}`}
                  >
                    <article className="border border-transparent rounded-[5px] overflow-hidden">
                      <div className="h-40">
                        <img className="w-full h-full" src="/images/blog/cool_dragon04.png" alt="" />
                      </div>
                      <div className="relative h-40 flex flex-col md:flex-row space-x-0 p-8 bg-pf-text text-pf-bg">
                ...
                <SplideSlide key={post.slug + "1"}>
                  <Link
                    ...
                    href={`/blog/${post.slug}`}
                  >
                    <article className="border rounded-[5px]">
                      <div className="h-40">
                        <img className="w-full h-full" src="/images/blog/cool_dragon04.png" alt="" />
                      </div>
                      <div className="h-40 flex flex-col md:flex-row space-x-0 p-8">
